page 50163 "Production  Header Recording"
{
    APIGroup = 'ProductionAPI';
    APIPublisher = 'VJ';
    APIVersion = 'v1.0';
    ApplicationArea = All;
    Caption = 'Production Recording Header API';
    DelayedInsert = true;
    EntityName = 'ProductionRecording';
    EntitySetName = 'ProductionRecordings';
    PageType = API;
    SourceTable = "Production Recording Header";
    SourceTableView = where("Prod Offred Balance" = filter(> 0));
