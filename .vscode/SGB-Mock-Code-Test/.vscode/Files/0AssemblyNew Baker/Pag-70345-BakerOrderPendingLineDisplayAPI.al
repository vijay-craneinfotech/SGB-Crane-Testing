page 70345 "BakerOrderPendingLineDisplay"   //this is working correct- https://api.businesscentral.dynamics.com/v2.0/f52861fd-85c4-4b16-b6a6-8b08b1901613/Sandbox/ODataV4/Company('CRONUS%20IN')/AssemblyOrder(documentType='Order',no='A00006')?$expand=AssemblyOrderLines
{                                         //it gives correct Get response service name= KichOrderHeaderLines
    ...
    APIVersion = 'v1.0';
    ApplicationArea = All;
    Caption = 'BakerOrderPendingLineDisplay';
    DelayedInsert = true;
    EntityName = 'BakerOrderPendingLineDisplay';
    EntitySetName = 'BakerOrderPendingLineDisplays';
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                part(Lines; "KichOrderDisplayPart")
                {
