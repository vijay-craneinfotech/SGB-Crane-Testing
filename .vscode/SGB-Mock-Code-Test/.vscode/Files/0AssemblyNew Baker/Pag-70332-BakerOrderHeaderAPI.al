page 70332 "BakerOrderHeader" // kichOrderHeader
{
    PageType = API;
    ...
    APIVersion = 'v1.0';
    ApplicationArea = All;
    Caption = 'BakerOrderHeader';
    DelayedInsert = true;
    EntityName = 'BakerOrderPending';            //KichOrderPending
    EntitySetName = 'BakerOrderPendings';          //KichOrderPendings
